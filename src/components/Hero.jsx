...
const Hero = () => {
  return (
    <div
      className='relative h-[320px] lg:min-h-[759px] bg-[#100E80] text-white overflow-hidden lg:py-15 py-4 px-4 md:px-8 rounded-b-2xl'
      style={{
    ...
    >
      ...
      <img
        ...
        className='absolute left-[-50px] w-[125px] md:w-52 rotate-[-30.1deg] z-10 top-[20%] lg:w-[364.53px] lg:h-[364.53px] lg:left-[3%]'
      />
      <img
        src={controllerOrange}
        alt='Orange Controller'
        className='absolute right-[-60px] w-36 md:w-52 rotate-[30deg] z-10 top-[27%] lg:w-[387.57px] lg:h-[247.68px] lg:right-[3%]'
      />
      <div className=''>
